...
object IngredientScoringParts {
  ...
  def recipeRecipeIngredientPart(
    ...
    s"""
       |MATCH (target)-[tr:HAS_EFFECTIVE_INGREDIENT]->(ti:Ingredient)
       ...
       |MATCH ($nodeVar)-[ci:HAS_EFFECTIVE_INGREDIENT]->(ciIngr:Ingredient)
  ...
  def userRecipeIngredientPart(
    ...
    s"""
       ...
       |MATCH (tRec)-[tr:HAS_EFFECTIVE_INGREDIENT]->(ti:Ingredient)
  ...
  def userUserIngredientPart(
    ...
    s"""
       ...
       |OPTIONAL MATCH (tRec)-[tr:HAS_EFFECTIVE_INGREDIENT]->(ti:Ingredient)
       ...
       |OPTIONAL MATCH (cRec)-[ci:HAS_EFFECTIVE_INGREDIENT]->(ciIngr:Ingredient)
